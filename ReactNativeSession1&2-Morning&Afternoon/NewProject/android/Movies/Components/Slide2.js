...
//https://api.themoviedb.org/3/movie/top_rated?api_key=d3fddab5b7eb58608ea30d3a66cab664&language=en-US&page=1
//top rated movies
...
const Slide2 = ({ navigation }) => {
    ...
    async function fetchMovies() {
        const response = await fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=d3fddab5b7eb58608ea30d3a66cab664&language=en-US&page=1');
    ...
    return (
        <>
            ...
            <SafeAreaView>
                <ScrollView>
                    <View><Text style={styles.h1}>Top Rated</Text></View>
                    <View>
                        <FlatList
                            data={movieData}
